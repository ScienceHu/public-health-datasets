...
label var le_lve_uhc "REASONS FOR LEAVING - UNDERLYING HEALTH CONDITION"
...
#delimit ;
 ...
 label define db_clinpriv_lab 1 "1: YES";
 label define db_clinpriv_lab 2 "2: NO", add;
 label define db_clinpriv_lab 3 "3: DON'T KNOW", add; label define db_clinpriv_lab .m "MISSING OR UNDEFINED", add; label define db_clinpriv_lab .l "LEGITIMATE SKIP", add; cap label values db_clinpriv db_clinpriv_lab;
